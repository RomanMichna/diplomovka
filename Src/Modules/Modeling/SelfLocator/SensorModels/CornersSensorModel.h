...
public:
  /** Constructor. */
  CornersSensorModel(const SelfLocatorParameters& selfLocatorParameters,
  ...
  */
                                      ...
                                      const vector<int>& selectedIndices, vector<float>& weightings)
  {
    ...
    gaussian.computeTable(1000, 200, theSelfLocatorParameters.standardDeviationCorners, theSelfLocatorParameters.standardDeviationCorners, 1);
...
NEXT_SAMPLE:
      ...
      for(int j = 0; j < (int) selectedIndices.size(); ++j)
      {
        ...
        weightings[i] *= gaussian.value(
                           ...
                           theSelfLocatorParameters.standardDeviationCorners);
        weightings[i] *= gaussian.value(
