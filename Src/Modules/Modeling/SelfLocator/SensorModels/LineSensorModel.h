...
public:
  /** Constructor. */
  LineSensorModel(const SelfLocatorParameters& selfLocatorParameters,
  ...
  */
                                      ...
                                      const vector<int>& selectedIndices, vector<float>& weightings)
  {
    ...
    gaussian.computeTable(1000, 200, theSelfLocatorParameters.standardDeviationFieldLines, theSelfLocatorParameters.standardDeviationFieldLines, 1);
...
NEXT_SAMPLE:
      ...
      for(int j = 0; j < (int) selectedIndices.size(); ++j)
      {
        ...
        weightings[i] *= gaussian.value(
                           ...
                           theSelfLocatorParameters.standardDeviationFieldLines);
        weightings[i] *= gaussian.value(
