...
private:
  ...
  */
  ...
  {
  public:
    Vector2f processNoise; /**< The standard deviation of the process. */
    Vector3f accNoise; /**< The standard deviation of the inertia sensor. */
    Vector2f calculatedAccLimit; /**< Use a calculated angle up to this angle (in rad). (We use the acceleration sensors otherwise.) */
