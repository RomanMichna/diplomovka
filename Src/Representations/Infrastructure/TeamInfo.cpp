...
void TeamInfo::draw()
{
  DECLARE_DEBUG_DRAWING3D("representation:TeamInfo", "field");
  {
    ...
    drawDigit(score / 10, Vector3<>(x, 2500, 1000), 200, teamColor);
    drawDigit(score % 10, Vector3<>(x + 270, 2500, 1000), 200, teamColor);
  };
}

void OwnTeamInfo::draw()
{
  ...
  {
    DRAWTEXT("representation:OwnTeamInfo",-3500,-2800,14,ColorClasses::red,((teamColor== TEAM_BLUE) ? "Blue" : "Red"));
  });
}
