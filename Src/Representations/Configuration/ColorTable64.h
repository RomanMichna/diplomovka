...
public:
  ...
  */
  ...
  /**
  * The method computes the average color of all colors with the 
  * given color class in the color table.
  * @param colorClass The color class the average color of which is to be determined.
  * @return The average color ov the color class in this color table.
  */
  Image::Pixel getAverageColor(ColorClasses::Color colorClass) const;
