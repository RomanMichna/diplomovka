...
{
  {
    ...
    DRAWTEXT("robotState", 1200, lineY, 150, ColorClasses::white, "activity: " << BehaviorData::getName(behaviorData.activity));
    lineY -= 180;
    ...
    {
      DRAWTEXT("robotState", 1200, lineY, 150, ColorClasses::white, "goalLastSeen: " << SystemCall::getRealTimeSince(goalPercept.timeWhenGoalPostLastSeen) << " ms");
    }
    else
    {
    ...
    if (robotHealth.usSensorDefect)
    {
      DRAWTEXT("robotState", 1200, lineY, 150, ColorClasses::white, "Ultra Sonic: defect");
    } 
    else
    {
      DRAWTEXT("robotState", 1200, lineY, 150, ColorClasses::white, "Ultra Sonic: valid");
    }
