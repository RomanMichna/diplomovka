...
public:
  ...
  bool active, /**< States whether modification of the color table is activated or not. */
       ...
       smart,
       autoct; /**< States wheter a normal click will call addPixel or trigger the automatic colortable generation. */
  ...
  */
  ...
  void autoCT(const Image& image);
  void setAutoCt(bool autoct);
  ...
  bool removeColor(string type, ColorClasses::Color color);
  bool kdDebug(bool debug)
  {
    ColorTableCreator::debugblocks = debug;
    return true;
  }
