...
#if QT_VERSION >= QT_VERSION_CHECK(4, 6, 0) && QT_VERSION < QT_VERSION_CHECK(4, 8, 0)
...
#ifdef MACOSX
#define QDOCKWIDGET_STYLE "QDockWidget::close-button { subcontrol-position: left; left: 4px; } QDockWidget::float-button { subcontrol-position: left; left: 24px; }"
#define QDOCKWIDGET_STYLE_FOCUS QDOCKWIDGET_STYLE "QDockWidget { font-weight: bold; }"
#define QDOCKWIDGET_STYLE_VERTICAL ""
#define QDOCKWIDGET_STYLE_VERTICAL_FOCUS QDOCKWIDGET_STYLE_VERTICAL "QDockWidget { font-weight: bold; }"
#else
#define QDOCKWIDGET_STYLE ""
#define QDOCKWIDGET_STYLE_FOCUS "QDockWidget {font-weight: bold;}"
#define QDOCKWIDGET_STYLE_VERTICAL ""
#define QDOCKWIDGET_STYLE_VERTICAL_FOCUS "QDockWidget {font-weight: bold;}"
#endif
  ...
  if(dockWidget && !dockWidget->hasWidget())
  {
    ...
    if(widget)
    {
      if(flags & SimRobot::Flag::verticalTitleBar)
      {
        ...
        dockWidget->setStyleSheet(dockWidget == activeDockWidget ? QDOCKWIDGET_STYLE_VERTICAL_FOCUS : QDOCKWIDGET_STYLE_VERTICAL);
      }
      else
...
void MainWindow::focusChanged(QWidget *old, QWidget* now)
{
  ...
  if(activeDockWidget)
  {
    activeDockWidget->setStyleSheet(activeDockWidget->features() & activeDockWidget->DockWidgetVerticalTitleBar ? QDOCKWIDGET_STYLE_VERTICAL : QDOCKWIDGET_STYLE);
  ...
  if(activeDockWidget)
  {
    activeDockWidget->setStyleSheet(activeDockWidget->features() & activeDockWidget->DockWidgetVerticalTitleBar ? QDOCKWIDGET_STYLE_VERTICAL_FOCUS : QDOCKWIDGET_STYLE_FOCUS);
